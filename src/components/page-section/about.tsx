    ...
    <div>
        <div className="space-y-2">
            ...
            <div className="flex flex-col gap-2">
              ...
              <p className="text-sm font-semibold text-gray-400">When I’m not coding, I love staying updated on emerging trends and collaborating with others on innovative projects. I'm always open to connecting with like-minded individuals and taking on opportunities that challenge and grow my skill set.</p>
            </div>
        </div>
    </div>
  )
